...
export function SisterClinic() {
    return (
        <section className="py-12 lg:py-10 2xl:py-24 px-6 md:px-12 lg:px-16 2xl:px-20 relative overflow-hidden bg-white dark:bg-slate-900" style={{ backgroundImage: 'radial-gradient(#e5e7eb 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <h2 className="font-display text-3xl md:text-4xl lg:text-3xl 2xl:text-5xl text-navy-custom dark:text-white mb-4 lg:mb-4 xl:mb-6">Connected Care</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 2xl:gap-20 items-center">
