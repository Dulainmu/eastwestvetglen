...
export function SisterClinic() {
    return (
        <section className="py-16 xl:py-24 px-6 md:px-12 lg:px-20 relative overflow-hidden bg-white dark:bg-slate-900" style={{ backgroundImage: 'radial-gradient(#e5e7eb 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <span className="text-primary font-bold tracking-wider uppercase text-xs mb-2 block">One Family, Two Locations</span>
                    <h2 className="font-display text-4xl md:text-5xl text-navy-custom dark:text-white mb-6">Connected Care</h2>
                    <p className="max-w-2xl mx-auto text-lg text-navy-custom/70 dark:text-slate-300 font-medium leading-relaxed">
