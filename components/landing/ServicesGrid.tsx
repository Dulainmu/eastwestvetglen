...
export function ServicesGrid() {
    return (
        <section className="py-12 lg:py-10 2xl:py-24 px-6 lg:px-8 2xl:px-12 bg-slate-50 dark:bg-slate-800/50 relative">
            <div className="max-w-7xl mx-auto relative z-10">
                <motion.div
                    className="text-center mb-10 lg:mb-8 2xl:mb-16"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                >
                    <h2 className="text-[10px] lg:text-[10px] 2xl:text-xs font-bold tracking-widest text-navy-custom/70 dark:text-slate-300 uppercase mb-2 lg:mb-2 2xl:mb-4 opacity-70">Compassionate & Comprehensive</h2>
                    <h1 className="font-display text-3xl md:text-3xl lg:text-2xl 2xl:text-6xl text-navy-custom dark:text-white mb-4 lg:mb-4 2xl:mb-6">
                        Complete Care for Your Companion
                    </h1>
                    <div className="w-16 lg:w-16 2xl:w-24 h-1 bg-primary mx-auto rounded-full"></div>
                    <p className="mt-4 lg:mt-4 2xl:mt-6 text-base lg:text-sm 2xl:text-lg text-navy-custom/80 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium">
