...
export default function OwnerRegisterPage() {
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
            {/* Background Gradients - Matches Owner Login */}
            ...
            <div className="w-full max-w-lg z-10 px-4 py-8">
                <Link
                    href="/login"
                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
                    <div className="px-8 pt-10 pb-6 text-center">
                        <div className="mx-auto h-14 w-14 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center shadow-lg mb-4 transform rotate-3 hover:rotate-6 transition-transform duration-300">
                        ...
                        <p className="mt-2 text-gray-300 text-sm">
                            Join VetFlow to manage your pet's health journey
                        </p>
                    </div>
