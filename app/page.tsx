...
export default function LandingPage() {
    return (
        <main className="relative z-10 flex-grow flex flex-col">
            {/* Hero Section */}
            <section className="flex items-center justify-center px-6 lg:px-8 xl:px-12 py-12 lg:py-0 min-h-screen lg:min-h-[600px] xl:min-h-[800px]">
                <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                    {/* Left Column: Content */}
                    <motion.div
                        className="flex flex-col gap-6 xl:gap-8 text-center lg:text-left order-2 lg:order-1"
                    ...
                    >
                        <div className="space-y-4 xl:space-y-6">
                            ...
                            <motion.h1 variants={fadeInUp} className="font-display text-5xl lg:text-5xl xl:text-7xl font-bold leading-[1.1] text-navy-custom dark:text-white">
                                Modern Care for Glen Waverley’s Best Friends.
                            </motion.h1>
                            <motion.p variants={fadeInUp} className="font-sans text-lg lg:text-lg xl:text-xl text-navy-custom/80 dark:text-slate-300 leading-relaxed max-w-lg mx-auto lg:mx-0 font-medium">
                                Independent, family-owned veterinary care where your pet is treated like one of our own.
                            </motion.p>
                        </div>

                        <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 xl:gap-6 mt-2">
                            <Link
                                href="/contact"
                                className="bg-primary hover:bg-green-700 text-white font-bold py-3 px-6 xl:py-4 xl:px-8 rounded-full shadow-xl shadow-primary/20 transition-all transform hover:scale-105 hover:shadow-2xl flex items-center gap-2 text-base xl:text-lg"
                            >
                            ...
                            <Link
                                href="/about"
                                className="group flex items-center gap-2 text-navy-custom dark:text-white font-semibold hover:text-white dark:hover:text-primary transition-colors text-base xl:text-lg"
                            >
                        ...
                        <motion.div variants={fadeInUp} className="pt-4 xl:pt-8 flex items-center justify-center lg:justify-start gap-6 opacity-80">
                            <div className="flex -space-x-3">
                                <img alt="Vet Avatar" className="w-8 h-8 xl:w-10 xl:h-10 rounded-full border-2 border-background-light dark:border-background-dark object-cover" src="/images/team_placeholder.png" />
                    ...
                    {/* Right Column: Image */}
                    <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end h-full min-h-[400px] lg:min-h-[500px] xl:min-h-[700px]">
                        ...
                        <motion.div
                            className="relative z-10 w-full max-w-md lg:max-w-sm xl:max-w-lg aspect-[3/4] overflow-hidden rounded-t-[10rem] xl:rounded-t-[12rem] rounded-b-3xl shadow-2xl shadow-navy-custom/20 dark:shadow-black/50 border-4 border-white/30 dark:border-slate-700/30 backdrop-blur-sm"
                        ...
                        >
                            ...
                            <motion.div
                                className="absolute bottom-6 right-6 xl:bottom-8 xl:right-8 bg-white dark:bg-slate-800 p-3 xl:p-4 rounded-2xl shadow-lg flex items-center gap-3 max-w-[180px] xl:max-w-[200px]"
                                variants={floatCard}
                            >
                                <div className="bg-green-100 dark:bg-green-900 p-2 rounded-full">
                                    <span className="material-icons-outlined text-primary text-lg xl:text-xl">pets</span>
                                </div>
                                <div>
